      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-left">
            <img src="/lovable-uploads/4eaf69a0-3b14-41bc-9166-fbbdb88668f0.png" alt="Foco Marketing" className="h-20 mb-3" />
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/termos-uso" className="text-gray-300 hover:text-blue-500 transition-colors">
                  Termos de Uso
                </a>
              </li>
            </ul>
